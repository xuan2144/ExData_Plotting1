...
#plot1
with(df_subset02, plot(dmy_hms(df_subset02$x_value), Global_active_power, type = "l", ylab = "Global Active Power", xlab=""))

#plot2
with(df_subset02, plot(dmy_hms(df_subset02$x_value), Voltage, type = "l", ylab = "Voltage", xlab="datetime"))
...
#plot4
with(df_subset02, plot(dmy_hms(df_subset02$x_value), Global_reactive_power, type = "l", ylab = "Global_reactive_power", xlab="datetime"))
